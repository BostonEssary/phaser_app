...
function preload() {
    this.load.image("header", "./assets/textover/header.png");
    this.load.spritesheet('button', './assets/textover/button.png', { frameWidth: 128, frameHeight: 48 });
}
